...
/* @var $model common\models\search\BadmintonMatchPlayerSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="badminton-match-player-search">
    ...
    <?php // echo $form->field($model, 'faults') ?>

    <?php // echo $form->field($model, 'double_faults') ?>
