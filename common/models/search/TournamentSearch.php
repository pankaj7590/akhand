...
class TournamentSearch extends Tournament
{
    ...
    {
        return [
            [['id', 'type', 'banner', 'logo', 'from_date', 'to_date', 'has_monetary_reward', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at', 'level'], 'integer'],
            [['name', 'info'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'has_monetary_reward' => $this->has_monetary_reward,
