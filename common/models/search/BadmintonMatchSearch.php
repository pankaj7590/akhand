...
/**
 * BadmintonMatchSearch represents the model behind the search form of `common\models\BadmintonMatch`.
 */
class BadmintonMatchSearch extends BadmintonMatch
{
    /**
     * @inheritdoc
     */
