...
class Media extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Member::className(), ['profile_picture' => 'id']);
    }
    ...
    {
        return $this->hasMany(Organization::className(), ['logo' => 'id']);
    }
    ...
    {
        return $this->hasMany(Team::className(), ['logo' => 'id']);
    }
    ...
    {
        return $this->hasMany(Tournament::className(), ['banner' => 'id']);
    }
    ...
    {
        return $this->hasMany(Tournament::className(), ['logo' => 'id']);
    }
