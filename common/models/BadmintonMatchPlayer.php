...
/**
 * This is the model class for table "badminton_match_player".
 *
 * @property int $id
 ...
 */
class BadmintonMatchPlayer extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['match_id', 'team_id', 'player_id', 'services', 'points_taken', 'unforced_errors', 'points_given', 'out_services', 'net_services', 'faults', 'double_faults', 'rallies', 'smashes', 'net_drops', 'returns', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
